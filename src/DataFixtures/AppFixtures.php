    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i <= 5; $i++) {
            ...
            for ($j = 0; $j <= 3; $j++) {
                ...
                $playlist->setName($faker->word(rand(1, 3), true));
                $playlist->setCreatedAt(\DateTimeImmutable::createFromMutable($faker->dateTimeThisDecade()));
                $playlist->setUser($user);
                $playlist->setIsPublic($faker->boolean());
